...
function Foot() {
  return (
    <footer class="sticky w-screen bottom-0 m-0 p-0 z-50 bg-gradient-to-br from-black to-blue-950">
      <div className='text-xm flex justify-between px-32'>
        <div className='text-justify'>
          <span className='text-xl font-bold'>gameshop</span> pusat download game terlengkap, aman, dan GRATIS. <br></br>
      ...
      <div>
        <ul className='flex items-center justify-center h-16 text-xs gap-20'>
            ...
            <li className='hover:opacity-50 hover:duration-300 hover:underline underline-offset-8'><Link to='/portfolio'>how to download </Link></li>
